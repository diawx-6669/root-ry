...
//
// За C2 раньше давали 🌈 — ту же самую радугу, что выпадает мифической
// аватаркой из легендарного кейса. Знак высшего уровня переучили на 🦉,
// которой нет ни в одном пуле магазина.
