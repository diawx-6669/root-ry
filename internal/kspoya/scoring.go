...
// Rewards — награды и знаки уровня. Знаки лежат в отдельном пространстве
// имён (rank_*) и не пересекаются с наградами из кейсов магазина: получить
// их можно только тестом.
//
// Раньше знаком C2 была радуга — та же самая, что выпадает мифической
// аватаркой из легендарного кейса; в профиле высший уровень был
// неотличим от везения в магазине.
var Rewards = map[string]Reward{
	"A1": {XP: 0, Coins: 0, Badge: "rank_a1", Label: "A1 — Начальный"},
	"A2": {XP: 300, Coins: 80, Badge: "rank_a2", Label: "A2 — Элементарный"},
	"B1": {XP: 750, Coins: 200, Badge: "rank_b1", Label: "B1 — Средний"},
	"B2": {XP: 1000, Coins: 300, Badge: "rank_b2", Label: "B2 — Выше среднего"},
	"C1": {XP: 1500, Coins: 400, Badge: "rank_c1", Label: "C1 — Продвинутый"},
	"C2": {XP: 2000, Coins: 500, Badge: "rank_c2", Label: "C2 — Мастерство"},
}
